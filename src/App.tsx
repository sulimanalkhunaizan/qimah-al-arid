...
const content = {
  ar: {
    ...
    services: {
      ...
      items: [
        { title: 'توريد وتركيب جميع أنواع التكييف', desc: 'مخفي، باكيج، كاسيت، سبيلت، صحراوي المطور' },
    ...
    about: {
      title: 'من نحن',
      description: 'قمة العارض للتكييف هي شركة رائدة في مجال التكييف والتبريد، تأسست منذ أكثر من 28 عاماً. نحن متخصصون في توريد وتركيب جميع أنواع أنظمة التكييف، بالإضافة إلى تصميم وتنفيذ مجاري الهواء والصيانة الشاملة. نفتخر بإدارة سعودية متخصصة وفريق فني محترف يضمن تقديم خدمات عالية الجودة تلبي جميع احتياجات عملائنا في مختلف القطاعات.',
      stats: [
